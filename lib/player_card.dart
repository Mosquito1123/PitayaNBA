...
class LeaguePlayersListWidgetState extends State {
  ...
  Widget loadFilteredPlayersView() {
    List<Widget> filteredPlayersWidget = players
        .where((player) =>
            player.firstName.toLowerCase().startsWith(filter) ||
    ...
    return (filteredPlayersWidget.isNotEmpty)
        ...
        : new Center(
            ...
            "No players found",
            style: new TextStyle(
                fontFamily: 'Signika', fontSize: 20.0, color: Colors.black),
          ));
  }
}
                ...
                children: <Widget>[
                  ...
                  new Positioned(
                    child: new FadeInImage(
                      ...
                      image:
                          new NetworkImage(Player.getImage(widget.player.id)),
                      height: 110.0,
                      width: 110.0,
                    ),
                    top: 3.0,
                ...
                children: <Widget>[
                  ...
                  new Positioned(
                    child: (widget.player.ppg == null)
                        ? new FutureBuilder(
                            future: setSeasonStats(widget.player),
                            builder:
